// Generated by dart2js (NullSafetyMode.unsound, deferred-serialization, csp), the Dart to JavaScript compiler version: 2.18.1.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    lisaaVastausvaihtoehto(vaihtoehto) {
      ...
      oikea = t1.createElement("div");
      oikea.className = "oikein";
      vaarin = t1.createElement("div");
      vaarin.className = "vaarin";
      t2 = type$._ElementEventStreamImpl_legacy_MouseEvent;
      t3 = t2._eval$1("~(1)?")._as(new A.lisaaVastausvaihtoehto_closure(vaihtoehto, oikea, vaarin));
      type$.nullable_void_Function._as(null);
      A._EventStreamSubscription$(elementti, "click", t3, false, t2._precomputed1);
      J.get$children$x(t1.querySelector(_s11_)).add$1(0, elementti);
      J.get$children$x(t1.querySelector(_s11_)).add$1(0, oikea);
      J.get$children$x(t1.querySelector(_s11_)).add$1(0, vaarin);
    },
  ...
  A.lisaaVastausvaihtoehto_closure.prototype = {
    call$1(e) {
      ...
      if (A.boolConversionCheck(A._asBoolS(J.$index$asx(this.vaihtoehto, "oikein"))))
        B.DivElement_methods.set$text(this.oikea, "oikein!");
      else
        B.DivElement_methods.set$text(this.vaarin, "v\xe4\xe4rin!");
    },
    $signature: 4
  };
  (function aliases() {
